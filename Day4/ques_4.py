...
# One day, you decide to arrange all your cats in a giant circle. Initially,none of your cats
# has a hat on.
# You walk around the circle a 100 times, always starting with the first cat (cat #1). 
# Each time you stop at a cat, you check if it has a hat on. If it doesn’t, then you put 
# a hat on it. If it does, then you take the hat off.
...
hat_positions = [i + 1 for i, has_hat in enumerate(cats) if has_hat]
